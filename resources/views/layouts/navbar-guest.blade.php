...
<nav x-data="{ open: false, mainMenu: false }" class="fixed inset-x-0 top-0 z-30 bg-[#0A5F2B] text-white shadow-sm border-white/10">
    ...
    <div class="w-full px-4 sm:px-6 lg:px-10 pt-[2px] pb-[5.5px]">
        <div class="relative flex items-center justify-between h-14">
            ...
            <div class="flex items-center gap-4 relative">
                ...
                {{-- TOMBOL MENU --}}
                <button type="button" @click="mainMenu = ! mainMenu"
                ...
                {{-- DROPDOWN MENU --}}
                <div x-cloak x-show="mainMenu" x-transition @click.outside="mainMenu = false"
                    ...
                    <div class="p-2 text-[13px] font-medium">
                        ...
                        <details class="group/sub relative">
                            <summary
                                class="list-none flex items-center justify-between rounded-lg px-4 py-2.5 text-[13px] font-medium hover:bg-white/10 cursor-pointer">
                                <span>Produsen</span>
                                <svg viewBox="0 0 24 24" class="h-4 w-4 transition-transform group-open/sub:rotate-180"
                ...
                {{-- ICON SEARCH --}}
                <button type="button" class="inline-flex items-center text-white/90 hover:text:white"
                    aria-label="Cari">
                    <svg viewBox="0 0 24 24" class="h-5 w-5" fill="none" stroke="currentColor" stroke-width="1.5">
