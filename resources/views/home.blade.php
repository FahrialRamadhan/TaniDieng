...
<body class="text-white antialiased">
    ...
    <div class="absolute inset-0">
        <img src="img/pemandangan.png" alt="Dieng background" class="h-full w-full object-cover object-center" />
        ...
        <div class="max-w-7xl mx-auto px-6 md:px-8">
            <div class="flex flex-col md:flex-row items-center justify-center gap-16">
                ...
                <a href="/pelanggan"
                    ...
                    <img src="img/image 26.png" alt="Pelanggan" class="w-1/2 h-full object-cover" />
                ...
                <a href="/produsen"
                    class="group flex w-[22rem] md:w-[35rem] lg:w-[35rem] h-40 overflow-hidden rounded-xl border border-white/25 bg-white/10 hover:bg-white/20 transition-all duration-300 shadow-md hover:shadow-lg">
                    <img src="img/image 27.png" alt="Produsen" class="w-1/2 h-full object-cover" />
                    <div class="flex items-center justify-center w-1/2">
    ...
    <section id="baru" class="bg-[#0F5529] text-white py-16">
        <div class="max-w-7xl mx-auto px-6">
            ...
            @if ($latestProducts->isEmpty())
                <p class="text-white/80">Belum ada produk yang ditambahkan.</p>
            @else
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8">

                    @foreach ($latestProducts as $product)
                        <article onclick="window.location.href='{{ route('detail.produk', $product->id) }}'"
                            class="w-[19rem] rounded-xl border border-white/20 bg-white/5 shadow-lg overflow-hidden flex flex-col hover:scale-[1.02] transition-transform">
                            ...
                            <div class="p-6 flex flex-col flex-1">
                                ...
                                <div class="mt-auto space-y-2 pt-4">
                                    ...
                                    {{-- BELI SEKARANG --}}
                                    <a href="{{ auth()->check() ? route('detail.produk', $product->id) : route('login') }}"
                                        class="block w-full rounded-md border border-white/40 bg-[#2A7A3A]/60 hover:bg-[#2A7A3A] text-center text-sm py-2">
                                        Beli Sekarang
                                    </a>
                                    ...
                                    @if (auth()->check())
                                        <form action="{{ route('cart.add', $product->id) }}" method="POST">
                                            @csrf
                                            <button type="submit"
                                                class="block w-full rounded-md border border-white/40 hover:bg-white/10 text-center text-sm py-2">
                                                Keranjang
                                            </button>
                                        </form>
                                    @else
            ...
            <div
                ...
                <div class="relative flex flex-col items-center justify-center text-center p-12">
                    ...
                    <div id="testimonialContainer" class="transition-all duration-300">
                        <img id="petaniFoto" src="img/petani/jono.png" alt="Jono Kagano"
        ...
        <div class="max-w-7xl mx-auto px-8 grid md:grid-cols-2 items-center gap-16">
            ...
            <div>
                ...
                <p class="text-white/85 leading-relaxed max-w-xl">
                    Era Tani telah muncul sebagai pelopor yang berperan penting dalam lanskap inovasi pertanian di
                    Indonesia.
    ...
    <section id="lokasi" class="bg-[#0F5529] text-white py-20">
        <div class="max-w-7xl mx-auto px-8">
            ...
            <div class="relative rounded-lg overflow-hidden">
                <!-- Peta -->
                <img src="img/indonesia.png" alt="Peta Indonesia"
                ...
                <!-- Garis penanda -->
                <span
                    class="absolute left-[34%] top-[84%] h-[80px] w-[3px] bg-white rotate-[-25deg] origin-top"></span>
            </div>
        </div>
    </section>
