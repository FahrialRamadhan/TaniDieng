<x-app-layout>
    ...
    <div x-data="cartPage()" x-init="init(@json(array_keys($cartItems)))"
            ...
            <div class="grid lg:grid-cols-[2fr,1fr] gap-6 items-start">
                            ...
                            <div class="flex items-center gap-3">
                                ...
                                <button type="button"
                                    ...
                                    <div x-show="isAllSelected()"
                                        class="h-[12px] w-[12px] rounded-[4px] bg-emerald-400/90" x-cloak>
                                    </div>
                                </button>
                            ...
                            @else
                                @foreach ($cartItems as $id => $item)
                                    @php
                                        ...
                                        $produsen =
                                            $isDynamic && !empty($product->produsen)
                                                ? $product->produsen
                                    ...
                                    <div id="item-{{ $id }}"
                                        class="px-5 py-4 border-b border-white/15 last:border-b-0">
                                        <div class="flex items-center gap-4">
                                            ...
                                            <button type="button"
                                                ...
                                                <div x-show="selected.includes('{{ $id }}')"
                                                    class="h-[11px] w-[11px] rounded-[3px] bg-emerald-400/90" x-cloak>
                                                </div>
                                            </button>
                                            ...
                                            <div class="flex-1">
                                                ...
                                                <div class="mt-3 flex items-center justify-between">
                                                    ...
                                                    <div class="flex items-center gap-3">
                                                        {{-- FAVORITE --}}
                                                        <form action="{{ route('cart.favorite', $id) }}" method="POST"
                                                            class="inline">
                                                            @csrf
                                                            <button type="submit"
                                                    ...
                                                    <div class="inline-flex items-center gap-2 text-sm"
                                                        ...
                                                        {{-- MINUS --}}
                                                        <button type="button" @click="change('decrease')"
                                                        ...
                                                        {{-- PLUS --}}
                                                        <button type="button" @click="change('increase')"
                                                            class="h-8 w-8 flex items-center justify-center rounded-full border border-white/55 bg-white/5 text-white hover:bg-white/15 transition">
                                                            +
                                                        </button>
                                                    </div>
                ...
                <div
                    ...
                    <div class="border-t border-white/20 pt-4 mt-4">
                        <a :href="`{{ route('checkout.index') }}?qty=${selected.length}`">
                            <button
